import { Card, Badge, Icon } from '@/component'
    ...
    <div className='*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4'>
        ...
        <Card.Header className='relative'>
          ...
          <div className='absolute top-4 right-4'>
            <Badge variant='outline' className='flex gap-1 rounded-lg text-xs'>
              <Icon name='trending-up' className='size-3' />
              +12.5%
            </Badge>
          </div>
        </Card.Header>
      ...
      <Card className='@container/card'>
        <Card.Header className='relative'>
          ...
          <div className='absolute top-4 right-4'>
            <Badge variant='outline' className='flex gap-1 rounded-lg text-xs'>
              <Icon name='trending-down' className='size-3' />
              -20%
            </Badge>
          </div>
        </Card.Header>
      ...
      <Card className='@container/card'>
        ...
        <Card.Footer className='flex-col items-start gap-1 text-sm'>
          <div className='line-clamp-1 flex gap-2 font-medium'>
            Steady performance <Icon name='trending-up' className='size-4' />
          </div>
