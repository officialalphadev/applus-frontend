...
import { Card, Select, useIsMobile, ToggleGroup, Chart, ChartConfig } from '@/component'
const chartData = [
      ...
      <Card.Header className='relative'>
        ...
        <div className='absolute top-4 right-4'>
          <ToggleGroup type='single' value={timeRange} onValueChange={setTimeRange} variant='outline' className='hidden @[767px]/card:flex'>
            <ToggleGroup.Item value='90d' className='h-8 px-2.5'>
              Last 3 months
            </ToggleGroup.Item>
            <ToggleGroup.Item value='30d' className='h-8 px-2.5'>
              Last 30 days
            </ToggleGroup.Item>
            <ToggleGroup.Item value='7d' className='h-8 px-2.5'>
              Last 7 days
            </ToggleGroup.Item>
          </ToggleGroup>
          <Select value={timeRange} onValueChange={setTimeRange}>
            <Select.Trigger className='flex w-40 @[767px]/card:hidden' aria-label='Select a value'>
